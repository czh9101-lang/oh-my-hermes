...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 196)
        self.assertEqual(payload["summary"]["negative_case_count"], 196)
        self.assertEqual(payload["summary"]["negative_passing_count"], 196)
        self.assertEqual(payload["summary"]["direct_answer_count"], 117)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 333)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 333)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 529)
        self.assertEqual(payload["summary"]["total_passing_count"], 529)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("196/196 negative-control cases passing", stdout)
        self.assertIn("Interventions: 333/333 expected workflow cases passing", stdout)
