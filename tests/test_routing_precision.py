...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 139)
        self.assertEqual(payload["summary"]["passing_count"], 139)
        self.assertEqual(payload["summary"]["negative_case_count"], 139)
        self.assertEqual(payload["summary"]["negative_passing_count"], 139)
        self.assertEqual(payload["summary"]["direct_answer_count"], 97)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 269)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 269)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 408)
        self.assertEqual(payload["summary"]["total_passing_count"], 408)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("139/139 negative-control cases passing", stdout)
        self.assertIn("Interventions: 269/269 expected workflow cases passing", stdout)
