...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 163)
        self.assertEqual(payload["summary"]["passing_count"], 163)
        self.assertEqual(payload["summary"]["negative_case_count"], 163)
        self.assertEqual(payload["summary"]["negative_passing_count"], 163)
        self.assertEqual(payload["summary"]["direct_answer_count"], 110)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 286)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 286)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 449)
        self.assertEqual(payload["summary"]["total_passing_count"], 449)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("163/163 negative-control cases passing", stdout)
        self.assertIn("Interventions: 286/286 expected workflow cases passing", stdout)
