...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["negative_case_count"], 78)
        self.assertEqual(payload["summary"]["negative_passing_count"], 78)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 187)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 187)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 265)
        self.assertEqual(payload["summary"]["total_passing_count"], 265)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("78/78 negative-control cases passing", stdout)
        self.assertIn("Interventions: 187/187 expected workflow cases passing", stdout)
