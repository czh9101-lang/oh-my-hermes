...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 202)
        self.assertEqual(payload["summary"]["negative_case_count"], 202)
        self.assertEqual(payload["summary"]["negative_passing_count"], 202)
        self.assertEqual(payload["summary"]["direct_answer_count"], 121)
        self.assertEqual(payload["summary"]["file_lookup_count"], 8)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 345)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 345)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 547)
        self.assertEqual(payload["summary"]["total_passing_count"], 547)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("202/202 negative-control cases passing", stdout)
        self.assertIn("Interventions: 345/345 expected workflow cases passing", stdout)
