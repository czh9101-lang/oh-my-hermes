...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["negative_case_count"], 71)
        self.assertEqual(payload["summary"]["negative_passing_count"], 71)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 259)
        self.assertEqual(payload["summary"]["total_passing_count"], 259)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("71/71 negative-control cases passing", stdout)
