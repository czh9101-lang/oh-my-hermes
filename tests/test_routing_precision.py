...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 161)
        self.assertEqual(payload["summary"]["passing_count"], 161)
        self.assertEqual(payload["summary"]["negative_case_count"], 161)
        self.assertEqual(payload["summary"]["negative_passing_count"], 161)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 283)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 283)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 444)
        self.assertEqual(payload["summary"]["total_passing_count"], 444)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("161/161 negative-control cases passing", stdout)
        self.assertIn("Interventions: 283/283 expected workflow cases passing", stdout)
