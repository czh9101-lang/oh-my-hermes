...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 93)
        self.assertEqual(payload["summary"]["negative_case_count"], 93)
        self.assertEqual(payload["summary"]["negative_passing_count"], 93)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 207)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 207)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 300)
        self.assertEqual(payload["summary"]["total_passing_count"], 300)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("93/93 negative-control cases passing", stdout)
        self.assertIn("Interventions: 207/207 expected workflow cases passing", stdout)
