...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 179)
        self.assertEqual(payload["summary"]["negative_case_count"], 179)
        self.assertEqual(payload["summary"]["negative_passing_count"], 179)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 322)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 322)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 501)
        self.assertEqual(payload["summary"]["total_passing_count"], 501)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("179/179 negative-control cases passing", stdout)
        self.assertIn("Interventions: 322/322 expected workflow cases passing", stdout)
