...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 112)
        self.assertEqual(payload["summary"]["negative_case_count"], 112)
        self.assertEqual(payload["summary"]["negative_passing_count"], 112)
        self.assertEqual(payload["summary"]["direct_answer_count"], 77)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 225)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 225)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 337)
        self.assertEqual(payload["summary"]["total_passing_count"], 337)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("112/112 negative-control cases passing", stdout)
        self.assertIn("Interventions: 225/225 expected workflow cases passing", stdout)
