...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 183)
        self.assertEqual(payload["summary"]["negative_case_count"], 183)
        self.assertEqual(payload["summary"]["negative_passing_count"], 183)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 326)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 326)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 509)
        self.assertEqual(payload["summary"]["total_passing_count"], 509)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("183/183 negative-control cases passing", stdout)
        self.assertIn("Interventions: 326/326 expected workflow cases passing", stdout)
