...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["negative_case_count"], 90)
        self.assertEqual(payload["summary"]["negative_passing_count"], 90)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 202)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 202)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 292)
        self.assertEqual(payload["summary"]["total_passing_count"], 292)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("90/90 negative-control cases passing", stdout)
        self.assertIn("Interventions: 202/202 expected workflow cases passing", stdout)
