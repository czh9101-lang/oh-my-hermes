...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 120)
        self.assertEqual(payload["summary"]["passing_count"], 120)
        self.assertEqual(payload["summary"]["negative_case_count"], 120)
        self.assertEqual(payload["summary"]["negative_passing_count"], 120)
        self.assertEqual(payload["summary"]["direct_answer_count"], 85)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 236)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 236)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 356)
        self.assertEqual(payload["summary"]["total_passing_count"], 356)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("120/120 negative-control cases passing", stdout)
        self.assertIn("Interventions: 236/236 expected workflow cases passing", stdout)
