...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 96)
        self.assertEqual(payload["summary"]["negative_case_count"], 96)
        self.assertEqual(payload["summary"]["negative_passing_count"], 96)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 308)
        self.assertEqual(payload["summary"]["total_passing_count"], 308)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("96/96 negative-control cases passing", stdout)
