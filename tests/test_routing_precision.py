...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 135)
        self.assertEqual(payload["summary"]["passing_count"], 135)
        self.assertEqual(payload["summary"]["negative_case_count"], 135)
        self.assertEqual(payload["summary"]["negative_passing_count"], 135)
        self.assertEqual(payload["summary"]["direct_answer_count"], 96)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 265)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 265)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 400)
        self.assertEqual(payload["summary"]["total_passing_count"], 400)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("135/135 negative-control cases passing", stdout)
        self.assertIn("Interventions: 265/265 expected workflow cases passing", stdout)
