...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["negative_case_count"], 74)
        self.assertEqual(payload["summary"]["negative_passing_count"], 74)
        self.assertEqual(payload["summary"]["direct_answer_count"], 67)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 188)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 188)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 262)
        self.assertEqual(payload["summary"]["total_passing_count"], 262)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("74/74 negative-control cases passing", stdout)
        self.assertIn("Interventions: 188/188 expected workflow cases passing", stdout)
