...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 180)
        self.assertEqual(payload["summary"]["negative_case_count"], 180)
        self.assertEqual(payload["summary"]["negative_passing_count"], 180)
        self.assertEqual(payload["summary"]["direct_answer_count"], 114)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 323)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 323)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 503)
        self.assertEqual(payload["summary"]["total_passing_count"], 503)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("180/180 negative-control cases passing", stdout)
        self.assertIn("Interventions: 323/323 expected workflow cases passing", stdout)
