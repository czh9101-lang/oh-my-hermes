...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 126)
        self.assertEqual(payload["summary"]["passing_count"], 126)
        self.assertEqual(payload["summary"]["negative_case_count"], 126)
        self.assertEqual(payload["summary"]["negative_passing_count"], 126)
        self.assertEqual(payload["summary"]["direct_answer_count"], 91)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 247)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 247)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 373)
        self.assertEqual(payload["summary"]["total_passing_count"], 373)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("126/126 negative-control cases passing", stdout)
        self.assertIn("Interventions: 247/247 expected workflow cases passing", stdout)
