...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 198)
        self.assertEqual(payload["summary"]["negative_case_count"], 198)
        self.assertEqual(payload["summary"]["negative_passing_count"], 198)
        self.assertEqual(payload["summary"]["direct_answer_count"], 118)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 341)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 341)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 539)
        self.assertEqual(payload["summary"]["total_passing_count"], 539)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("198/198 negative-control cases passing", stdout)
        self.assertIn("Interventions: 341/341 expected workflow cases passing", stdout)
