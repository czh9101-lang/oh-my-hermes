...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 133)
        self.assertEqual(payload["summary"]["passing_count"], 133)
        self.assertEqual(payload["summary"]["negative_case_count"], 133)
        self.assertEqual(payload["summary"]["negative_passing_count"], 133)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 257)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 257)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 390)
        self.assertEqual(payload["summary"]["total_passing_count"], 390)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("133/133 negative-control cases passing", stdout)
        self.assertIn("Interventions: 257/257 expected workflow cases passing", stdout)
