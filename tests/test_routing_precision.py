...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 155)
        self.assertEqual(payload["summary"]["passing_count"], 155)
        self.assertEqual(payload["summary"]["negative_case_count"], 155)
        self.assertEqual(payload["summary"]["negative_passing_count"], 155)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 277)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 277)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 432)
        self.assertEqual(payload["summary"]["total_passing_count"], 432)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("155/155 negative-control cases passing", stdout)
        self.assertIn("Interventions: 277/277 expected workflow cases passing", stdout)
