...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["negative_case_count"], 75)
        self.assertEqual(payload["summary"]["negative_passing_count"], 75)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 192)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 192)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 267)
        self.assertEqual(payload["summary"]["total_passing_count"], 267)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("75/75 negative-control cases passing", stdout)
        self.assertIn("Interventions: 192/192 expected workflow cases passing", stdout)
