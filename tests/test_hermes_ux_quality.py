...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["chat_card_cases"], 79)
        self.assertEqual(payload["summary"]["chat_card_generic_ack_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_cases"], 199)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 199)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 157)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 157)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 279)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 279)
