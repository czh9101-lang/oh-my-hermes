...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["chat_card_cases"], 78)
        self.assertEqual(payload["summary"]["chat_card_generic_ack_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_cases"], 198)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 198)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 155)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 155)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 277)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 277)
