...
_RULES = (
    ...
    CoverageRule(
        ...
        "OMH can evaluate memory-provider plugins for provenance, retention, backend authority, retrieval evidence, and safety boundaries before provider selection or recall output is claimed, and can preserve those answers plus identity scope, automatic hooks, deletion, export, and switching in a memory_provider_posture/v1 block.",
