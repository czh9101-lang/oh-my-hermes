...
# 719955 -> 720443: the ultrawork and ralplan todo-init quality-bar rules
# gained an English-labels clause (+488 chars: phase names and task titles stay
# English even in a non-English conversation, since the HUD todo checklist is
# an operator surface under the repo's English-by-default output contract);
# warranted growth.
FULL_PROFILE_SKILL_BODY_CHAR_LIMIT = 720443
